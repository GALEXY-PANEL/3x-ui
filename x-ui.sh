...
update_menu() {
    ...
    if replace_xui_script "https://raw.githubusercontent.com/GALEXY-PANEL/3x-ui/main/x-ui.sh" "false"; then
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/GALEXY-PANEL/3x-ui/main/install.sh)${plain}"
    echo ""
...
update_shell() {
    if replace_xui_script "https://raw.githubusercontent.com/GALEXY-PANEL/3x-ui/main/x-ui.sh" "true"; then
