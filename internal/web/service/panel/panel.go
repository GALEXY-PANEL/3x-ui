...
import (
	...
	"github.com/GALEXY-PANEL/3x-ui/v3/internal/web/global"
...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/GALEXY-PANEL/3x-ui/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/GALEXY-PANEL/3x-ui/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/GALEXY-PANEL/3x-ui/releases/tags/" + tag
	}
