---
title: Установка
description: Установите Heimdall с помощью официального скрипта (стабильная, фиксированная или dev-сборка), в автоматическом режиме / через cloud-init либо в Docker — и выберите SQLite или PostgreSQL.
icon: Download
---

Heimdall работает на широком спектре дистрибутивов Linux — Ubuntu, Debian, Armbian,
...
bash <(curl -Ls https://raw.githubusercontent.com/GALEXY-PANEL/3x-ui/main/install.sh) v3.4.0
```
...
[страницы релизов](https://github.com/GALEXY-PANEL/3x-ui/releases), распаковать его и
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/GALEXY-PANEL/3x-ui/main/install.sh)
```

В каталоге [`deploy/`](https://github.com/GALEXY-PANEL/3x-ui/tree/main/deploy)
