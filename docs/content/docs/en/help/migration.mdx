---
title: Migration
description: Migrate to Heimdall from x-ui, between servers, or between Heimdall versions.
icon: ArrowRightLeft
---
...
<Step>
### Install Heimdall on the new server
...
versions, read the [release notes](https://github.com/GALEXY-PANEL/3x-ui/releases)
first and take a backup.

## From x-ui

Importing an older x-ui panel's database directly into Heimdall is **not
supported** — the schemas differ. Install Heimdall fresh and recreate
