---
title: Contributing
description: How to contribute to Heimdall and to translate this documentation.
icon: GitPullRequestArrow
---

Heimdall is community-driven. Contributions to the panel and to these docs are
welcome.

## Support the developer

Heimdall is free and open source, built and maintained in the open. If it's useful
to you, consider supporting continued development:

- **Donate** at [reymit.ir/heimdall](https://reymit.ir/heimdall) — the page shows
  current funding **goals and targets** you can help reach.
- **Star** the [repository](https://github.com/GALEXY-PANEL/3x-ui) and share the
  project.
- **Join** the Telegram channel [@XrayUI](https://t.me/XrayUI) to follow news and
  help others.

## Contribute to Heimdall

- Read the project's `CONTRIBUTING.md` in the
  [repository](https://github.com/GALEXY-PANEL/3x-ui).
