---
title: FAQ
description: Frequently asked questions about Heimdall — licensing, supported systems, databases, and clients.
icon: CircleQuestionMark
---

## Is Heimdall free and open source?

Yes. Heimdall is open source under the GPL-3.0 license. The source is on
[GitHub](https://github.com/GALEXY-PANEL/3x-ui).
...
## How is Heimdall related to 3X-UI and X-UI?

Heimdall is based on the 3X-UI project by MHSanaei, which itself derives from X-UI.
Heimdall adds broader protocol support, improved stability, per-client traffic
...
[releases page](https://github.com/GALEXY-PANEL/3x-ui/releases).
...
[GitHub](https://github.com/GALEXY-PANEL/3x-ui/issues). For common problems, start
