...
description: Fix common Heimdall problems — the panel won't start, 502 errors, certificate issues, and clients that can't connect.
icon: Wrench
---
...
<Callout type="info">
  ...
  [GitHub issues](https://github.com/GALEXY-PANEL/3x-ui/issues) — your symptom has
