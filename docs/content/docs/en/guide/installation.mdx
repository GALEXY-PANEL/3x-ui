---
title: Installation
description: Install Heimdall via the official script (stable, pinned, or dev-latest), unattended/cloud-init, or Docker — and choose SQLite or PostgreSQL.
icon: Download
---

Heimdall runs on a wide range of Linux distributions — Ubuntu, Debian, Armbian,
...
[releases page](https://github.com/GALEXY-PANEL/3x-ui/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/GALEXY-PANEL/3x-ui/tree/main/deploy)
