---
title: Security
description: Harden Heimdall — panel auth and 2FA, custom-core IP limits, firewall rules, BBR, and staying current.
icon: ShieldCheck
---
...
Update Heimdall and Xray-core regularly — security fixes land in new releases. Watch
the [releases page](https://github.com/GALEXY-PANEL/3x-ui/releases) and see
