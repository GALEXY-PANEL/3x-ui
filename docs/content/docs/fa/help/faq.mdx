---
title: سؤالات متداول
description: پرسش‌های پرتکرار درباره Heimdall — مجوز، سیستم‌های پشتیبانی‌شده، پایگاه‌های داده و کلاینت‌ها.
icon: CircleQuestionMark
---

## آیا Heimdall رایگان و متن‌باز است؟

بله. Heimdall تحت مجوز GPL-3.0 متن‌باز است. کد منبع آن روی
[GitHub](https://github.com/GALEXY-PANEL/3x-ui) در دسترس است.
...
## رابطه Heimdall با 3X-UI و X-UI چیست؟

Heimdall بر پایهٔ پروژهٔ 3X-UI از MHSanaei توسعه یافته است و 3X-UI نیز از X-UI مشتق شده است.
Heimdall پشتیبانی گسترده‌تر از پروتکل‌ها، پایداری بهبودیافته، حسابداری ترافیک به‌ازای هر کلاینت،
...
[صفحه نسخه‌ها](https://github.com/GALEXY-PANEL/3x-ui/releases) مراجعه کنید.
...
[GitHub](https://github.com/GALEXY-PANEL/3x-ui/issues) باز کنید. برای مشکلات رایج، با
