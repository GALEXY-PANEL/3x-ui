---
title: 安全加固
description: 加固 Heimdall——面板认证与 2FA、自定义核心 IP 限制、防火墙规则、BBR，以及保持更新。
icon: ShieldCheck
---
...
定期更新 Heimdall 和 Xray-core——安全修复会随新版本发布。请关注
[发布页面](https://github.com/GALEXY-PANEL/3x-ui/releases)，并参见
