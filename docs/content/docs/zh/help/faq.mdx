---
title: 常见问题
description: 关于 Heimdall 的常见问题 —— 许可协议、受支持的系统、数据库以及客户端。
icon: CircleQuestionMark
---

## Heimdall 是免费且开源的吗？

是的。Heimdall 基于 GPL-3.0 许可协议开源，源代码托管在
[GitHub](https://github.com/GALEXY-PANEL/3x-ui) 上。
...
## Heimdall 与 3X-UI 和 X-UI 有什么关系？

Heimdall 基于 MHSanaei 的 3X-UI 项目开发，而 3X-UI 本身源自 X-UI。
Heimdall 在此基础上增加了更广泛的协议支持、更佳的稳定性、
...
[发布页面](https://github.com/GALEXY-PANEL/3x-ui/releases)。

## 我可以在哪里获取帮助？

加入官方 Telegram 频道 [@XrayUI](https://t.me/XrayUI) 获取公告与社区支持，
或在 [GitHub](https://github.com/GALEXY-PANEL/3x-ui/issues) 上提交 issue。遇到常见问题时，
